...
class SimpleAlert {
    ...
    class func showSimpleAlert(title: String, detail: String?, isOkPressed: @escaping (Bool) -> Void ){
        ...
        let label = UILabel()
        label.text = title
        label.textColor = #colorLiteral(red: 0.9607843137, green: 0.3803921569, blue: 0.4549019608, alpha: 1)
        ...
        cancelButton.setBackgroundImage(UIImage(named: "btn_border"), for: .normal)
