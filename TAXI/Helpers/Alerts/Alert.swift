...
//  RoviTalk
//
//  Created by Nodirbek Asqarov on 4/9/20.
//  Copyright © 2020 Some Organization. All rights reserved.
//
...
class Alert {
    ...
    class func showAlert(forState: AlertType, message: String, duration: TimeInterval = 3, userInteration: Bool = true) {
        ...
        closeBtn.setImage(#imageLiteral(resourceName: "cancel_gray").withRenderingMode(.alwaysTemplate), for: .normal)
